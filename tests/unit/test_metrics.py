import numpy as np
import pytest
from argonx.decision_rules.metrics import compute_prob_best, compute_expected_loss, compute_cvar, compute_rope, compute_lift_hdi, compute_all_metrics, _validate_inputs, _validate_config
...
class TestComputeAllMetrics:
    ...
    def test_full_pipeline_runs(self):
        ...
        res = compute_all_metrics(samples, ['A', 'B'], control='A', rope_bounds=(-0.1, 0.1))
