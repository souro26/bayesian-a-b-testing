...
def make_hier_binary(n_mobile=200, n_desktop=500, n_tv=30):
    return {
        "mobile":  {"control": np.random.binomial(1, 0.10, n_mobile), "variant_b": np.random.binomial(1, 0.14, n_mobile)},
        "desktop": {"control": np.random.binomial(1, 0.10, n_desktop), "variant_b": np.random.binomial(1, 0.13, n_desktop)},
        "tv":      {"control": np.random.binomial(1, 0.10, n_tv),      "variant_b": np.random.binomial(1, 0.12, n_tv)},
    }

def make_hier_lognormal(n_mobile=200, n_desktop=500, n_tv=30):
    return {
        "mobile":  {"control": np.random.lognormal(3.8, 0.6, n_mobile), "variant_b": np.random.lognormal(3.9, 0.6, n_mobile)},
        "desktop": {"control": np.random.lognormal(3.8, 0.6, n_desktop), "variant_b": np.random.lognormal(3.85, 0.6, n_desktop)},
        "tv":      {"control": np.random.lognormal(3.8, 0.6, n_tv),      "variant_b": np.random.lognormal(3.82, 0.6, n_tv)},
    }

def make_hier_gaussian(n_mobile=200, n_desktop=500, n_tv=30):
    return {
        "mobile":  {"control": np.random.normal(100, 10, n_mobile), "variant_b": np.random.normal(108, 10, n_mobile)},
        "desktop": {"control": np.random.normal(100, 10, n_desktop), "variant_b": np.random.normal(105, 10, n_desktop)},
        "tv":      {"control": np.random.normal(100, 10, n_tv),      "variant_b": np.random.normal(102, 10, n_tv)},
    }

def make_hier_poisson(n_mobile=200, n_desktop=500, n_tv=30):
    return {
        "mobile":  {"control": np.random.poisson(5, n_mobile).astype(int),  "variant_b": np.random.poisson(6, n_mobile).astype(int)},
        "desktop": {"control": np.random.poisson(5, n_desktop).astype(int), "variant_b": np.random.poisson(6, n_desktop).astype(int)},
        "tv":      {"control": np.random.poisson(5, n_tv).astype(int),      "variant_b": np.random.poisson(5, n_tv).astype(int)},
    }
...
class TestHierarchicalBinaryModel:
    ...
    def test_rejects_non_binary_values(self):
        ...
        model = HierarchicalBinaryModel()
        data = {
            "mobile":  {"control": np.array([0, 1, 2]), "variant_b": np.array([1, 0, 1])},
...
class TestHierarchicalLogNormalModel:
    ...
    def test_rejects_non_positive_values(self):
        ...
        model = HierarchicalLogNormalModel()
        data = {
            "mobile":  {"control": np.array([1.0, -1.0]), "variant_b": np.array([1.0, 2.0])},
            "desktop": {"control": np.array([1.0, 2.0]),  "variant_b": np.array([2.0, 3.0])},
        }
        with pytest.raises(ValueError):
            model.fit(data)
    ...
    def test_rejects_inconsistent_variants(self):
        ...
        model = HierarchicalLogNormalModel()
        data = {
            "mobile":  {"control": np.array([1.0, 2.0]), "variant_b": np.array([2.0, 3.0])},
            "desktop": {"control": np.array([1.0, 2.0]), "variant_c": np.array([2.0, 3.0])},
        }
        with pytest.raises(ValueError):
            model.fit(data)
...
class TestHierarchicalPoissonModel:
    ...
    def test_rejects_negative_values(self):
        ...
        model = HierarchicalPoissonModel()
        data = {
            "mobile":  {"control": np.array([-1, 2], dtype=int), "variant_b": np.array([1, 2], dtype=int)},
            "desktop": {"control": np.array([1, 2], dtype=int),  "variant_b": np.array([2, 3], dtype=int)},
        }
        with pytest.raises(ValueError):
            model.fit(data)
    ...
    def test_rejects_non_integer_values(self):
        ...
        model = HierarchicalPoissonModel()
        data = {
            "mobile":  {"control": np.array([1.5, 2.0]), "variant_b": np.array([1.0, 2.0])},
            "desktop": {"control": np.array([1, 2], dtype=int), "variant_b": np.array([2, 3], dtype=int)},
        }
        with pytest.raises(ValueError):
            model.fit(data)
    ...
    def test_rejects_inconsistent_variants(self):
        ...
        model = HierarchicalPoissonModel()
        data = {
            "mobile":  {"control": np.array([1, 2], dtype=int), "variant_b": np.array([2, 3], dtype=int)},
            "desktop": {"control": np.array([1, 2], dtype=int), "variant_c": np.array([2, 3], dtype=int)},
        }
        with pytest.raises(ValueError):
            model.fit(data)
